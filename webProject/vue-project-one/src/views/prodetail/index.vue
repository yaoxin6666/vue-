...
{{detail.goods_name}}
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in commentList" :key="item.comment_id">
          <div class="top">
            ...
            <van-rate :size="16" :value="item.score/4" color="#ffd21e" void-icon="star" void-color="#eee"/>
          </div>
          <div class="content">
            {{item.content}}
          </div>
  ...
  <span>购物车</span>
      ...
      <div class="btn-add" @click="addCount">加入购物车</div>
...
export default {
  ...
  methods: {
    ...
    async addCart () {
      ...
      const { data } = await addCart(this.goodsId, this.Count, this.detail.skuList[0].goods_sku_id)
  ...
  async created () {
    ...
    const { data: { list, total } } = await getProductComments(this.goodsId)
